...
\subsection{Pojęcia i relacje między pojęciami}
...
\subsection{Wprowadzanie bytów do dyskursu}
...
\subsection{Modyfikatory nieintersektywne}
...
\subsection{Relacja quasi-posiadania i identyczności}
...
\subsection{Relacje przestrzenne}
...
\subsection{Sytuacje, procesy i relacje czasowe}
...
\subsection{Stopniowanie przymiotników i przysłówków oraz konstrukcje porównawcze, relacyjne i wprowadzające kolejność}
...
\subsection{Partykuły przyrematyczne i nieprawdomówne, podmiot epistemiczny}
...
\subsection{Koordynacja}\label{coordination}
...
\subsection{Spójniki podrzędne i zaimki względne}
...
\subsection{Dalsze zagadnienia dotyczące koordynacji}
\begin{itemize}
...
\subsection{Zasoby istniejące i wymagające wytworzenia}
%TODO OPISAĆ
