...
\subsection{Wstęp} % (fold)
{
\renewcommand\thesubsection{}
\renewcommand\thesubsubsection{}
\setcounter{subsection}{-1}
\subsubsection{Zakres i przeznaczenie listy} % (fold)
}
...
\renewcommand\thesubsubsection{}
\setcounter{subsection}{-1}
\subsubsection{Opis zjawiska} % (fold)
...
\subsection{Niejawne argumenty semantyczne} % (fold)
{
\renewcommand\thesubsection{}
\renewcommand\thesubsubsection{}
\setcounter{subsection}{-1}
...
% subsection definicja_robocza (end)
\subsubsection{Lista niejawnych argumentów semantycznych} % (fold)
\label{niejawne}
...
\subsection{Znaczenie relacji składniowych} % (fold)

\subsubsection{Uogólniona intersektywność} % (fold)
...
\subsubsection{Niefaktywność} % (fold)
...
\subsection{Cechy składniowo-semantyczne jednostek nieopisanych w zasobach} % (fold)
{
\renewcommand\thesubsection{}
\renewcommand\thesubsubsection{}
\setcounter{subsection}{-1}
\subsubsection{Opis problemu} % (fold)
...
\subsubsection{Lista cech składniowo-semantycznych} % (fold)
...
\subsection{Oznaczanie miary i liczebności referenta} % (fold)
{
\renewcommand\thesubsection{}
\renewcommand\thesubsubsection{}
\setcounter{subsection}{-1}
...
\subsubsection{Użycie pojemnikowe} % (fold)
\label{pojemniki}
...
\subsubsection{Podział liczebników ze względu na dokładność} % (fold)
...
\subsubsection{Miara referentów niepoliczalnych} % (fold)
...
\subsection{Niedenotatywne funkcje języka} % (fold)
{
\renewcommand\thesubsection{}
\renewcommand\thesubsubsection{}
\setcounter{subsection}{-1}
