...
import unittest
from wosedon.reranks import LemmaRankingFirstSelecter
from wosedon.basegraph import BaseGraph
from wosedon.utils.config import Config



class TestLemmaRankingFirstSelecter(unittest.TestCase):
  ...
  def setUp(self):
    ...
    self.graph = g
    self.rerank = LemmaRankingFirstSelecter()
  ...
  def test_it(self):
    ...
    self.nodes[9].synset.lu_set = {LU('można', 3)}
