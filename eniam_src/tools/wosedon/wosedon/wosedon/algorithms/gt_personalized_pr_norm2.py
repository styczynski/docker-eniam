...
class GTPersonalizedPRNorm2(WSDAlgorithmInterface):
  """!
  ...
  "v" for all its meanings (synsets) will be 1/N/M, where M is the number of
  all lemmas from the analyzed context. If this same synset occur in two 
  lemmas from the analyzed context then boths values are added.
  ...
  def __init__(self, str_name = 'GTPersonalizedPRNorm2'):
    """!
    @param str_name - default value same as the class name "GTPersonalizedPRNorm2"
    """
    super(GTPersonalizedPRNorm2, self).__init__(str_name)
