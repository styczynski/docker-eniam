...
let transform_pers_phrase lemma negation mood = function
  ...
  | AdjP CaseAgr as morf -> if mood = "gerundial" then [AdjP AllAgr] else [](*failwith ("transform_pers_phrase2: " ^ lemma ^ " " ^ ENIAMwalStringOf.phrase morf)*) (* FIXME: trzeba by zrobić mapowanie między przymiotnikami i przysłówkami *)
