...
let linear_term_beta_reduction4 references =
  ...
  let rec flatten_variant set = function
    ...
    | t -> failwith ("flatten_variant: " ^ ENIAM_LCGstringOf.linear_term 0 t)
...
(*   ENIAM_LCGlatexOf.print_references "results/" "references1" "a0" references; *)
...
(*   ENIAM_LCGlatexOf.print_references "results/" "references2" "a0" references; *)
  dependency_tree
