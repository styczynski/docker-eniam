...
let load_mte_patterns () =
  ...
  List.rev (Xlist.rev_map l (fun (orths,lemma,interp) ->
    Xlist.map orths (function
      ...
      | "’" -> I "’"
      | "..." -> I "…"
      | orth -> T orth), (fun (_:token_env list) -> ENIAMtokens.make_lemma (lemma,interp))))
...
let abr_patterns = [
  [T "b"; S "."; T "u"; S "."],			(function [a;b;c;d] -> 	[ct [a;b] "bez" "prep:gen:nwok"; ct [c;d] "uwaga" "subst:pl:gen:f"] | _ -> failwith "abr_patterns");
  [T "b"; S "."; T "zm"; S "."],		(function [a;b;c;d] -> 	[ct [a;b] "bez" "prep:gen:nwok"; ct [c;d] "zmiana" "subst:pl:gen:f"] | _ -> failwith "abr_patterns");
  ...
  [T "błp"; S "."],				(function [a;b] -> 	std a b [2,"błogosławiony","adj:sg:gen:f:pos";1,"pamięć","subst:sg:gen:f"] | _ -> failwith "abr_patterns");
  [T "bm"],					(function [a] -> 	st a [1,"bieżący","adj:sg:$c:m3:pos";1,"miesiąc","subst:sg:$c:m3"] | _ -> failwith "abr_patterns");
  [T "bm"; S "."],				(function [a;b] -> 	std a b [1,"bieżący","adj:sg:$c:m3:pos";1,"miesiąc","subst:sg:$c:m3"] | _ -> failwith "abr_patterns");
  [T "bp"; S "."],				(function [a;b] -> 	std a b [1,"błogosławiony","adj:sg:gen:f:pos";1,"pamięć","subst:sg:gen:f"] | _ -> failwith "abr_patterns");
  [T "br"],					(function [a] -> 	st a [1,"bieżący","adj:sg:$c:m3:pos";1,"rok","subst:sg:$c:m3"] | _ -> failwith "abr_patterns");
  [T "br"; S "."],				(function [a;b] -> 	std a b [1,"bieżący","adj:sg:$c:m3:pos";1,"rok","subst:sg:$c:m3"] | _ -> failwith "abr_patterns");
  [T "c"; S "."; T "d"; S "."; T "n"; S "."],	(function [a;b;c;d;e;f] -> [ct [a;b] "ciąg" "subst:sg:nom:m3"; ct [c;d] "daleki" "adj:sg:nom:m3:com"; ct [e;f] "nastąpić" "fin:sg:ter:perf"] | _ -> failwith "abr_patterns");
  [T "ccm"],					(function [a] -> 	st a [1,"sześcienny","adj:_:$c:m3:pos";2,"centymetr","subst:_:$c:m3"] | _ -> failwith "abr_patterns");
  [T "cd"; S "."],				(function [a;b] -> 	std a b [1,"ciąg","subst:sg:nom:m3";1,"daleki","adj:sg:nom:m3:com"] | _ -> failwith "abr_patterns");
  [T "cdn"; S "."],				(function [a;b] -> 	std a b [1,"ciąg","subst:sg:nom:m3";1,"daleki","adj:sg:nom:m3:com";1,"nastąpić","fin:sg:ter:perf"] | _ -> failwith "abr_patterns");
  [T "cm"; T "3"],				(function [a;b] -> 	[ct [a] "centymetr" "subst:_:$c:m3"; ct [b] "sześcienny" "adj:_:$c:m3:pos"] | _ -> failwith "abr_patterns");
  [T "dcn"; S "."],				(function [a;b] -> 	std a b [1,"daleki","adj:sg:nom:m3:com";1,"ciąg","subst:sg:nom:m3";1,"nastąpić","fin:sg:ter:perf"] | _ -> failwith "abr_patterns");
  [T "dm"; T "3"],				(function [a;b] -> 	[ct [a] "decymetr" "subst:_:$c:m3"; ct [b] "sześcienny" "adj:_:$c:m3:pos"] | _ -> failwith "abr_patterns");
  [T "ds"; S "."],				(function [a;b] -> 	std a b [1,"do","prep:gen";1,"sprawa","subst:pl:gen:f"] | _ -> failwith "abr_patterns");
  [T "d"; T "/"; T "s"],			(function [a;b;c] -> 	[ct [a;b] "do" "prep:gen"; ct [c] "sprawa" "subst:pl:gen:f"] | _ -> failwith "abr_patterns");
  [T "itd"; S "."],				(function [a;b] -> 	std a b [1,"i","conj";1,"tak","adv:pos";1,"daleko","adv:com"] | _ -> failwith "abr_patterns");
  [T "itede"; S "."],				(function [a;b] -> 	std a b [1,"i","conj";2,"tak","adv:pos";2,"daleko","adv:com"] | _ -> failwith "abr_patterns");
  [T "itp"; S "."],				(function [a;b] -> 	std a b [1,"i","conj";1,"tym","adv";1,"podobny","adj:pl:nom:_:pos"] | _ -> failwith "abr_patterns");
  [T "j"; S "."; T "m"; S "."],		(function [a;b;c;d] -> 	[ct [a;b] "jednostka" "subst:_:_:f"; ct [c;d] "miary" "subst:sg:gen:f"] | _ -> failwith "abr_patterns");
  [T "j"; S "."; T "m"; S "."],		(function [a;b;c;d] -> 	[ct [a;b] "jednostka" "subst:_:_:f"; ct [c;d] "międzynarodowy" "adj:_:_:f:pos"] | _ -> failwith "abr_patterns");
  [T "jw"; S "."],				(function [a;b] -> 	std a b [1,"jak","adv:pos";1,"wysoko","adv:com"] | _ -> failwith "abr_patterns");
  ...
  [T "km"; S "."; T "2"],			(function [a;b;c] -> 	[ct [a;b] "kilometr" "subst:_:$c:m3"; ct [c] "kwadratowy" "adj:_:$c:m3:pos"] | _ -> failwith "abr_patterns");
  ...
  [T "lm"; S "."],				(function [a;b] -> 	std a b [1,"liczba","subst:sg:$c:f";1,"mnogi","adj:sg:$c:f:pos"] | _ -> failwith "abr_patterns");
  [T "lp"; S "."],				(function [a;b] -> 	std a b [1,"liczba","subst:sg:$c:f";1,"pojedynczy","adj:sg:$c:f:pos"] | _ -> failwith "abr_patterns");
  [T "m"; S "."; T "in"; S "."],		(function [a;b;c;d] -> 	[ct [a;b] "między" "prep:inst"; ct [c;d] "inny" "adj:pl:inst:_:pos"] | _ -> failwith "abr_patterns");
  [T "m"; S "."; T "in"],			(function [a;b;c] -> 	[ct [a;b] "między" "prep:inst"; ct [c] "inny" "adj:pl:inst:_:pos"] | _ -> failwith "abr_patterns");
  [T "m"; S "."; T "inn"; S "."],		(function [a;b;c;d] -> 	[ct [a;b] "między" "prep:inst"; ct [c;d] "inny" "adj:pl:inst:_:pos"] | _ -> failwith "abr_patterns");
  [T "m"; S "."; T "st"; S "."],		(function [a;b;c;d] -> 	[ct [a;b] "miasto" "subst:_:$c:n:ncol"; ct [c;d] "stołeczny" "adj:_:$c:n:pos"] | _ -> failwith "abr_patterns");
  ...
  (* [T "min"; S "."],				(function [a;b] -> 	std a b [1,"między","prep:inst";2,"inny","adj:pl:inst:_:pos"] | _ -> failwith "abr_patterns"); *)
  [T "mc"; S "."],				(function [a;b] -> 	std a b [1,"masa","subst:sg:$c:f";1,"ciało","subst:sg:gen:n:ncol"] | _ -> failwith "abr_patterns");
  [T "mkw"; S "."],				(function [a;b] -> 	std a b [1,"metr","subst:_:$c:m3";2,"kwadratowy","adj:_:$c:m3:pos"] | _ -> failwith "abr_patterns");
  [T "n"; S "."; T "e"; S "."],			(function [a;b;c;d] -> 	[ct [a;b] "nasz" "adj:sg:gen:f:pos"; ct [c;d] "era" "subst:sg:gen:f"] | _ -> failwith "abr_patterns");
  [T "n"; S "."; T "p"; S "."; T "m"; S "."],	(function [a;b;c;d;e;f] -> [ct [a;b] "nad" "prep:inst"; ct [c;d] "poziom" "subst:sg:inst:m3"; ct [e;f] "morze" "subst:sg:gen:n:ncol"] | _ -> failwith "abr_patterns");
  [T "np"; S "."],				(function [a;b] -> 	std a b [1,"na","prep:acc";1,"przykład","subst:sg:acc:m3"] | _ -> failwith "abr_patterns");
  [T "nt"; S "."],				(function [a;b] -> 	std a b [1,"na","prep:acc";1,"temat","subst:sg:acc:m3"] | _ -> failwith "abr_patterns");
  [T "NTG"],					(function [a] -> 	st a [1,"nie","qub";1,"ta","adj:sg:nom:f:pos";1,"grupa","subst:sg:nom:f"] | _ -> failwith "abr_patterns");
  [T "o"; S "."; T "o"; S "."],			(function [a;b;c;d] -> 	[ct [a;b] "ograniczony" "adj:sg:$c:f:pos"; ct [c;d] "odpowiedzialność" "subst:sg:$c:f"] | _ -> failwith "abr_patterns");
  [T "p"; S "."; T "n"; S "."; T "e"; S "."],	(function [a;b;c;d;e;f] -> [ct [a;b] "przed" "prep:inst"; ct [c;d] "nasz" "adj:sg:inst:f:pos"; ct [e;f] "era" "subst:sg:inst:f"] | _ -> failwith "abr_patterns");
  [T "p"; S "."; T "o"; S "."],			(function [a;b;c;d] -> 	[ct [a;b] "pełniący" "pact:_:_:m1.m2.m3:imperf:aff"; ct [c;d] "obowiązek" "subst:pl:acc:m3"] | _ -> failwith "abr_patterns");
  [T "p"; S "."; T "p"; S "."; T "m"; S "."],	(function [a;b;c;d;e;f] -> [ct [a;b] "pod" "prep:inst"; ct [c;d] "poziom" "subst:sg:inst:m3"; ct [e;f] "morze" "subst:sg:gen:n:ncol"] | _ -> failwith "abr_patterns");
  [T "p"; S "."; T "t"; S "."],			(function [a;b;c;d] -> 	[ct [a;b] "pod" "prep:inst:nwokc"; ct [c;d] "tytuł" "subst:sg:inst:m3"] | _ -> failwith "abr_patterns");
  [T "pn"; S "."],				(function [a;b] -> 	std a b [1,"pod","prep:inst";1,"nazwa","subst:sg:inst:f"] | _ -> failwith "abr_patterns");
  [T "pne"; S "."],				(function [a;b] -> 	std a b [1,"przed","prep:inst";1,"nasz","adj:sg:inst:f:pos";1,"era","subst:sg:inst:f"] | _ -> failwith "abr_patterns");
  [T "pt"; S "."],				(function [a;b] -> 	std a b [1,"pod","prep:inst";1,"tytuł","subst:sg:inst:m3"] | _ -> failwith "abr_patterns");
  [T "PW"],					(function [a] -> 	st a [1,"prywatny","adj:_:$c:f:pos";1,"wiadomość","subst:_:$c:f"] | _ -> failwith "abr_patterns");
  [T "pw"; S "."],				(function [a;b] -> 	std a b [1,"pod","prep:inst";1,"wezwanie","subst:sg:inst:n:ncol"] | _ -> failwith "abr_patterns");
(*  [T "S"; S "."; T "A"; S "."],			(function [a;b;c;d] -> 	[ct [a;b] "spółka" "subst:sg:$c:f"; ct [c;d] "akcyjny" "adj:sg:$c:f:pos"] | _ -> failwith "abr_patterns");
  [T "s"; S "."; T "c"; S "."],			(function [a;b;c;d] -> 	[ct [a;b] "spółka" "subst:sg:$c:f"; ct [c;d] "cywilny" "adj:sg:$c:f:pos"] | _ -> failwith "abr_patterns");*)
(*   [T "SA"],					(function [a] -> 	st a [1,"spółka","subst:sg:$c:f";1,"akcyjny","adj:sg:$c:f:pos"] | _ -> failwith "abr_patterns"); *)
  [T "ś"; S "."; T "p"; S "."],			(function [a;b;c;d] -> 	[ct [a;b] "święty" "adj:sg:gen:f:pos"; ct [c;d] "pamięć" "subst:sg:gen:f"] | _ -> failwith "abr_patterns");
  [T "śp"; S "."],				(function [a;b] -> 	std a b [1,"święty","adj:sg:gen:f:pos";1,"pamięć","subst:sg:gen:f"] | _ -> failwith "abr_patterns");
  [T "tgz"; S "."],				(function [a;b] -> 	std a b [2,"tak","adv";1,"zwać","ppas:_:_:_:_:aff"] | _ -> failwith "abr_patterns");
  [T "tj"; S "."],				(function [a;b] -> 	std a b [1,"to","subst:sg:nom:n:ncol";1,"być","fin:sg:ter:imperf"] | _ -> failwith "abr_patterns");
  [T "tzn"; S "."],				(function [a;b] -> 	std a b [1,"to","subst:sg:nom:n:ncol";2,"znaczyć","fin:sg:ter:imperf"] | _ -> failwith "abr_patterns");
  [T "tzw"; S "."],				(function [a;b] -> 	std a b [1,"tak","adv:pos";2,"zwać","ppas:_:_:_:imperf:aff"] | _ -> failwith "abr_patterns");
  [T "ub"; S "."; T "r"; S "."],		(function [a;b;c;d] -> 	[ct [a;b] "ubiegły" "adj:sg:$c:m3:pos"; ct [c;d] "rok" "subst:sg:$c:m3"] | _ -> failwith "abr_patterns");
  [T "w"; S "."; T "w"; S "."],			(function [a;b;c;d] -> 	[ct [a;b] "wysoko" "adv:com"; ct [c;d] "wymienić" "ppas:_:_:_:perf:aff"] | _ -> failwith "abr_patterns");
  ...
  [T "ws"; S "."],				(function [a;b] -> 	std a b [1,"w","prep:loc:nwok";1,"sprawa","subst:sg:loc:f"] | _ -> failwith "abr_patterns");
  [T "ww"; S "."],				(function [a;b] -> 	std a b [1,"wysoko","adv:com";1,"wymieniony","ppas:_:_:_:perf:aff"] | _ -> failwith "abr_patterns");
  ]
